...
#include "..\..\..\World\IO\ConsoleSaveFileIO.h"
...
HRESULT CScene_MultiGameJoinLoad::GetSaveInfo(  )
{
	...
	else
	{
		...
		//CStorageManager::ESaveGameState eStatus=StorageManager.GetSavesInfo(ProfileManager.GetPrimaryPad(),&CScene_MultiGameJoinLoad::GetSavesInfoCallback,this,"savegame.dat");
...
int CScene_MultiGameJoinLoad::DeviceRemovedDialogReturned(void *pParam,int iPad,CStorageManager::EMessageResult result)
{
...
int CScene_MultiGameJoinLoad::DeleteSaveDialogReturned(void *pParam,int iPad,CStorageManager::EMessageResult result)
{
	CScene_MultiGameJoinLoad* pClass = (CScene_MultiGameJoinLoad*)pParam;
	// results switched for this dialog
	if(result==CStorageManager::EMessage_ResultDecline) 
...
int CScene_MultiGameJoinLoad::SaveTransferDialogReturned(void *pParam,int iPad,CStorageManager::EMessageResult result)
{
	CScene_MultiGameJoinLoad* pClass = (CScene_MultiGameJoinLoad*)pParam;
	// results switched for this dialog
	if(result==CStorageManager::EMessage_ResultAccept) 
	{
		...
		CStorageManager::ELoadGameStatus eLoadStatus=StorageManager.LoadSaveData(&ContentData,CScene_MultiGameJoinLoad::LoadSaveDataReturned,pClass);
...
int CScene_MultiGameJoinLoad::UploadSaveForXboxOneThreadProc( LPVOID lpParameter )
{
	...
	// Upload the metadata and thumbnail
	{
		...
		char szUniqueMapName[MAX_SAVEFILENAME_LENGTH];
...
void CScene_MultiGameJoinLoad::DeleteFile(CScene_MultiGameJoinLoad *pClass, char *filename)
{
	...
	CStorageManager::ETMSStatus result = StorageManager.TMSPP_DeleteFile(
		ProfileManager.GetPrimaryPad(),
		filename,
		CStorageManager::TMS_FILETYPE_BINARY,
		&CScene_MultiGameJoinLoad::DeleteComplete,
		pClass,
		NULL);

	if(result != CStorageManager::ETMSStatus_DeleteInProgress)
	{
...
void CScene_MultiGameJoinLoad::UploadFile(CScene_MultiGameJoinLoad *pClass, char *filename, LPVOID data, DWORD size)
{
	...
	CStorageManager::ETMSStatus result = StorageManager.TMSPP_WriteFileWithProgress(
			ProfileManager.GetPrimaryPad(),
			CStorageManager::eGlobalStorage_TitleUser,
			CStorageManager::TMS_FILETYPE_BINARY,
			CStorageManager::TMS_UGCTYPE_NONE,
			filename,
			(CHAR *)data, 
			size,
	...
	if(result != CStorageManager::ETMSStatus_WriteInProgress)
	{
...
int CScene_MultiGameJoinLoad::SaveOptionsDialogReturned(void *pParam,int iPad,CStorageManager::EMessageResult result)
{
	CScene_MultiGameJoinLoad* pClass = (CScene_MultiGameJoinLoad*)pParam;
	...
	{
		if(result==CStorageManager::EMessage_ResultDecline) // rename
		{
...
int CScene_MultiGameJoinLoad::TexturePackDialogReturned(void *pParam,int iPad,CStorageManager::EMessageResult result)
{
	CScene_MultiGameJoinLoad *pClass = (CScene_MultiGameJoinLoad *)pParam;

	// Exit with or without saving
	// Decline means install full version of the texture pack in this dialog
	if(result==CStorageManager::EMessage_ResultDecline || result==CStorageManager::EMessage_ResultAccept) 
	{
