...
protected:
	...
	XUI_END_MSG_MAP()
		...
		static int DeviceRemovedDialogReturned(void *pParam,int iPad,CStorageManager::EMessageResult result);
		...
		static int ConfirmLoadReturned(void *pParam,int iPad,CStorageManager::EMessageResult result);
		...
		static int CheckResetNetherReturned(void *pParam,int iPad,CStorageManager::EMessageResult result);
...
private:
	static int UnlockTexturePackReturned(void *pParam,int iPad,CStorageManager::EMessageResult result);
