...
#include "..\..\..\Client\MultiplayerLocalPlayer.h"
...
HRESULT UIScene_PauseMenu::OnNotifyPressEx(HXUIOBJ hObjPressed, XUINotifyPress* pNotifyPressData, BOOL& rfHandled)
{
	...
	case BUTTON_PAUSE_SAVEGAME:		
		{	
			...
			// does the save exist?
			bool bSaveExists;
			CStorageManager::ELoadGameStatus result=StorageManager.DoesSaveExist(&bSaveExists);

			if(result == CStorageManager::ELoadGame_DeviceRemoved)
			{
...
int UIScene_PauseMenu::DeviceRemovedDialogReturned(void *pParam,int iPad,CStorageManager::EMessageResult result)
{
...
int UIScene_PauseMenu::ExitGameDeclineSaveReturned(void *pParam,int iPad,CStorageManager::EMessageResult result)
{
	// results switched for this dialog
	if(result==CStorageManager::EMessage_ResultDecline) 
	{
...
int UIScene_PauseMenu::ExitGameAndSaveReturned(void *pParam,int iPad,CStorageManager::EMessageResult result)
{
...
int UIScene_PauseMenu::SaveGameDialogReturned(void *pParam,int iPad,CStorageManager::EMessageResult result)
{
	// results switched for this dialog
	if(result==CStorageManager::EMessage_ResultDecline) 
	{
...
int UIScene_PauseMenu::ExitGameDialogReturned(void *pParam,int iPad,CStorageManager::EMessageResult result)
{
	// results switched for this dialog
	if(result==CStorageManager::EMessage_ResultDecline) 
	{
