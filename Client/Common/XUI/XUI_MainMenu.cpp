...
#endif // OVERRIDE_XUI_FONT_RENDERER
	}
...
int CScene_Main::MustSignInReturned(void *pParam,int iPad,CStorageManager::EMessageResult result)
{
	CScene_Main* pClass = (CScene_Main*)pParam;
...
int CScene_Main::ExitGameReturned(void *pParam,int iPad,CStorageManager::EMessageResult result)
{
	//CScene_Main* pClass = (CScene_Main*)pParam;
...
int CScene_Main::TMSReadFileListReturned(void *pParam,int iPad,CStorageManager::PTMSPP_FILE_LIST pTmsFileList)
{
	CScene_Main* pClass = (CScene_Main*)pParam;
...
int CScene_Main::TMSFileReadReturned(void *pParam,int iPad,CStorageManager::PTMSPP_FILEDATA pData)
{
	CScene_Main* pClass = (CScene_Main*)pParam;
