...
HRESULT CXuiSceneBase::_ShowSavingMessage( unsigned int iPad, CStorageManager::ESavingMessage eVal )
{
	switch(eVal)
	{
...
HRESULT CXuiSceneBase::ShowSavingMessage( unsigned int iPad, CStorageManager::ESavingMessage eVal )
{
	if( CXuiSceneBase::Instance != NULL )
	{
