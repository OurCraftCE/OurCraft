		...
		if(m_bGameModeSurvival != true || m_bHasBeenInCreative)
		{
			...
			else // it's creative mode
			{
				...
				if(m_bHasBeenInCreative)
				{
					...
					{
						CStorageManager::ELoadGameStatus eLoadStatus=StorageManager.LoadSaveData(&m_XContentData,CScene_LoadGameSettings::LoadSaveDataReturned,this);

						if(eLoadStatus==CStorageManager::ELoadGame_DeviceRemoved)
						{
							// disable saving 
...
int CScene_LoadGameSettings::CheckResetNetherReturned(void *pParam,int iPad,CStorageManager::EMessageResult result)
{
...
int CScene_LoadGameSettings::ConfirmLoadReturned(void *pParam,int iPad,CStorageManager::EMessageResult result)
{
	CScene_LoadGameSettings* pClass = (CScene_LoadGameSettings*)pParam;
	...
	if(result==CStorageManager::EMessage_ResultAccept) 
	{
		...
		{
			CStorageManager::ELoadGameStatus eLoadStatus=StorageManager.LoadSaveData(&pClass->m_XContentData,CScene_LoadGameSettings::LoadSaveDataReturned,pClass);
...
int CScene_LoadGameSettings::DeleteSaveDialogReturned(void *pParam,int iPad,CStorageManager::EMessageResult result)
{
	CScene_LoadGameSettings* pClass = (CScene_LoadGameSettings*)pParam;
...
int CScene_LoadGameSettings::DeviceRemovedDialogReturned(void *pParam,int iPad,CStorageManager::EMessageResult result)
{
...
int CScene_LoadGameSettings::UnlockTexturePackReturned(void *pParam,int iPad,CStorageManager::EMessageResult result)
{
...
int CScene_LoadGameSettings::TexturePackDialogReturned(void *pParam,int iPad,CStorageManager::EMessageResult result)
{
	CScene_LoadGameSettings *pClass = (CScene_LoadGameSettings *)pParam;
	pClass->m_bIgnoreInput=false;
	return 0;
