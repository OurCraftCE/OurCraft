...
int CScene_MultiGameCreate::UnlockTexturePackReturned(void *pParam,int iPad,CStorageManager::EMessageResult result)
{
...
int CScene_MultiGameCreate::WarningTrialTexturePackReturned(void *pParam,int iPad,CStorageManager::EMessageResult result)
{
	CScene_MultiGameCreate* pScene = (CScene_MultiGameCreate*)pParam;
	pScene->m_bIgnoreInput = false;
	pScene->SetShow( TRUE );
...
int CScene_MultiGameCreate::ConfirmCreateReturned(void *pParam,int iPad,CStorageManager::EMessageResult result)
{
...
int CScene_MultiGameCreate::TexturePackDialogReturned(void *pParam,int iPad,CStorageManager::EMessageResult result)
{
	CScene_MultiGameCreate *pClass = (CScene_MultiGameCreate *)pParam;
