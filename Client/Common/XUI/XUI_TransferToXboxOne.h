...
//#include "..\Media\xuiscene_TransferToXboxOne.h"  // Xbox-only media file, not present in Windows build
...
public:
	...
	static int TMSPPSlotListReturned(LPVOID pParam,int iPad,int iUserData,CStorageManager::PTMSPP_FILEDATA pFileData, LPCSTR szFilename);
