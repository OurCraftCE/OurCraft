...
private:
	...
	HRESULT						_ShowSavingMessage( unsigned int iPad, CStorageManager::ESavingMessage eVal );
...
public:
	...
	static HRESULT				ShowSavingMessage( unsigned int iPad, CStorageManager::ESavingMessage eVal);
