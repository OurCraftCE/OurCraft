...
protected:
	...
	enum ESceneSection
	{
		...
		eSectionInventoryCraftGrid,
		eSectionInventoryCraftResult,
		...
		// Crafting Table (Java/Bedrock style 3x3 grid)
		eSectionCraftTableUsing,
		eSectionCraftTableInventory,
		eSectionCraftTableGrid,        // 3x3 crafting grid
		eSectionCraftTableResult,      // crafting result slot
		eSectionCraftTableMax,
	};
