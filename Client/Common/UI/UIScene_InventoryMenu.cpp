...
UIScene_InventoryMenu::UIScene_InventoryMenu(int iPad, void *_initData, UILayer *parentLayer) : UIScene_AbstractContainerMenu(iPad, parentLayer)
{
	...
	m_slotListCraftGrid.addSlots(InventoryMenu::CRAFT_SLOT_START, InventoryMenu::CRAFT_SLOT_END - InventoryMenu::CRAFT_SLOT_START);
	m_slotListCraftResult.addSlots(InventoryMenu::RESULT_SLOT, 1);
