...
private:
	...
	static int TrophyDialogReturned(void *pParam,int iPad,CStorageManager::EMessageResult result);
	...
	static int MustSignInReturnedPSN(void *pParam,int iPad,CStorageManager::EMessageResult result);
