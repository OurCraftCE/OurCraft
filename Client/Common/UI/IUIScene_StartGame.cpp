...
void IUIScene_StartGame::HandleDLCMountingComplete()
{
	...
	for(unsigned int i = 0; i < (unsigned int)texturePacksCount; ++i)
	{
	...
	for(unsigned int i = 0; i < (unsigned int)app.GetDLCInfoTexturesOffersCount(); ++i)
	{
...
int IUIScene_StartGame::TrialTexturePackWarningReturned(void *pParam,int iPad,CStorageManager::EMessageResult result)
{
...
int IUIScene_StartGame::UnlockTexturePackReturned(void *pParam,int iPad,CStorageManager::EMessageResult result)
{
	IUIScene_StartGame* pScene = (IUIScene_StartGame*)pParam;
...
int IUIScene_StartGame::TexturePackDialogReturned(void *pParam,int iPad,CStorageManager::EMessageResult result)
{
