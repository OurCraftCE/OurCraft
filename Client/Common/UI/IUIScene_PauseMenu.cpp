...
int IUIScene_PauseMenu::ExitGameDialogReturned(void *pParam,int iPad,CStorageManager::EMessageResult result)
{
...
int IUIScene_PauseMenu::ExitGameSaveDialogReturned(void *pParam,int iPad,CStorageManager::EMessageResult result)
{
	IUIScene_PauseMenu *scene = (IUIScene_PauseMenu *)pParam;
...
int IUIScene_PauseMenu::ExitGameAndSaveReturned(void *pParam,int iPad,CStorageManager::EMessageResult result)
{
...
int IUIScene_PauseMenu::ExitGameDeclineSaveReturned(void *pParam,int iPad,CStorageManager::EMessageResult result)
{
	IUIScene_PauseMenu *scene = (IUIScene_PauseMenu *)pParam;
...
int IUIScene_PauseMenu::WarningTrialTexturePackReturned(void *pParam,int iPad,CStorageManager::EMessageResult result)
{
	return 0;
}
...
int IUIScene_PauseMenu::SaveGameDialogReturned(void *pParam,int iPad,CStorageManager::EMessageResult result)
{
	// results switched for this dialog
	if(result==CStorageManager::EMessage_ResultDecline) 
	{
...
int IUIScene_PauseMenu::EnableAutosaveDialogReturned(void *pParam,int iPad,CStorageManager::EMessageResult result)
{
	// results switched for this dialog
	if(result==CStorageManager::EMessage_ResultDecline) 
	{
...
int IUIScene_PauseMenu::DisableAutosaveDialogReturned(void *pParam,int iPad,CStorageManager::EMessageResult result)
{
	// results switched for this dialog
	if(result==CStorageManager::EMessage_ResultDecline) 
	{
