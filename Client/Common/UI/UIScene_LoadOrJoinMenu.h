...
public:
	...
	static int DeleteSaveDialogReturned(void *pParam,int iPad,CStorageManager::EMessageResult result);
	static int SaveOptionsDialogReturned(void *pParam,int iPad,CStorageManager::EMessageResult result);
...
private:
	...
	typedef struct _SaveTransferStateContainer
	{
		...
		bool m_bSaveTransferCancelled;
		int m_iPad;
		CStorageManager::eSaveTransferState m_eSaveTransferState;
	...
	static CStorageManager::SAVETRANSFER_FILE_DETAILS m_debugTransferDetails;
	...
	static int SaveTransferReturned(LPVOID lpParam,CStorageManager::SAVETRANSFER_FILE_DETAILS *pSaveTransferDetails);
	...
	static int NeedSyncMessageReturned(void *pParam,int iPad,CStorageManager::EMessageResult result);
	...
	static int CrossSaveFinishedCallback(void *pParam,int iPad,CStorageManager::EMessageResult result);
	static int CrossSaveDeleteOnErrorReturned(LPVOID lpParam,bool bRes);
	static int RemoteSaveNotFoundCallback(void *pParam,int iPad,CStorageManager::EMessageResult result);
	...
	static int SaveTransferDialogReturned(void *pParam,int iPad,CStorageManager::EMessageResult result);
	static int CrossSaveUploadFinishedCallback(void *pParam,int iPad,CStorageManager::EMessageResult result);
#endif

	static int CopySaveDialogReturned(void *pParam,int iPad,CStorageManager::EMessageResult result);
	static int CopySaveThreadProc( LPVOID lpParameter );
	static int CopySaveDataReturned( LPVOID lpParameter, bool success, CStorageManager::ESaveGameState state );
	static bool CopySaveDataProgress(LPVOID lpParam, int percent);
	static void CancelCopySaveCallback(LPVOID lpParam);
	static int CopySaveErrorDialogFinishedCallback(void *pParam,int iPad,CStorageManager::EMessageResult result);
};
