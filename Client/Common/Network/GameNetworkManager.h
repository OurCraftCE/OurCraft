...
class CGameNetworkManager
{
	...
	friend class CSteamNetworkManager;
public:
	CGameNetworkManager();
	...
	static int		MustSignInReturned_1(void *pParam,int iPad,CStorageManager::EMessageResult result);
...
public:
	...
	RakNetTransport* GetTransport() { return m_transport; }
	NetworkAdapter* GetAdapter() { return m_adapter; }
};
