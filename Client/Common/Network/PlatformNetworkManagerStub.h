...
#include "..\..\..\Core\Network\TransportTypes.h"
...
private:
	...
	// RakNet connection tracking
	ConnectionId	m_rakNetHostConnection;  // client: ConnectionId of the host
	std::unordered_map<uint64_t, BYTE> m_connIdToSmallId;  // host: map ConnectionId -> smallId
	BYTE m_nextSmallId = 1;
	std::vector<BYTE> m_freeSmallIds;
