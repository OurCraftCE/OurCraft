...
// eTitleStorageState - maps to CStorageManager::ETMSStatus values
// Originally defined in platform-specific storage headers
enum eTitleStorageState
{
	eTitleStorage_idle = 0,				// ETMSStatus_Idle
	eTitleStorage_readerror = 1,		// ETMSStatus_Fail
	eTitleStorage_busy = 2,				// ETMSStatus_Fail_ReadInProgress
	eTitleStorage_pending = 4			// ETMSStatus_Pending
};
