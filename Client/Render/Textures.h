...
public:
	static bool MIPMAP;
	static BgfxRenderer::eTextureFormat TEXTURE_FORMAT;
...
public:
	int loadTexture(const wstring& resourceName);
	int loadTexture(int idx);			// 4J added
	int getTexture(BufferedImage *img, BgfxRenderer::eTextureFormat format = BgfxRenderer::TEXTURE_FORMAT_RxGyBzAw, bool mipmap = true);
