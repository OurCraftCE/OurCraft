...
#include "Options.h"
#include "../Screens/TextEditScreen.h"
#include "../Screens/ContainerScreen.h"
#include "../Screens/CraftingScreen.h"
#include "../Screens/FurnaceScreen.h"
#include "../Screens/TrapScreen.h"
...
#include "../../World/FwdHeaders/net.minecraft.world.damagesource.h"
...
#include "../../World/IO/com.mojang.nbt.h"
...
#include "../../World/Entities\Minecart.h"
#include "../../World/Entities\Boat.h"
#include "../../World/Entities\Pig.h"
...
#ifndef _DURANGO
#include "../../World/Stats\CommonStats.h"
#endif
...
{
	bool success = app.LoadCraftingTableMenu(GetXboxPad(), dynamic_pointer_cast<LocalPlayer>( shared_from_this() ), x, y, z);
	if( success ) ui.PlayUISFX(eSFX_Press);
	return success;
}
...
void LocalPlayer::awardStat(Stat *stat, byteArray param)
{
    ...
    if (stat->isAchievement())
	{
		...
		{
            // 4J-PB - Don't display the java popup (re-enabled on Windows where no platform UI exists)
#ifdef _WINDOWS64
...
// 4J TODO - Remove
#include "../../World/Level\LevelChunk.h"
