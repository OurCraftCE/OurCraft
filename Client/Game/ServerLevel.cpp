...
#include "../../World/FwdHeaders/net.minecraft.world.entity.ai.village.h"
...
#include "../../World/Entities\ItemEntity.h"
#include "../../World/Entities\Arrow.h"
#include "../../World/Entities\PrimedTnt.h"
#include "../../World/Entities\FallingTile.h"
#include "../../World/FwdHeaders/net.minecraft.network.packet.h"
#include "../../World/Math\Mth.h"
#include "../../World/FwdHeaders/net.minecraft.world.level.levelgen.feature.h"
#include "../../World/FwdHeaders/net.minecraft.world.item.h"
#include "../../World/WorldGen\StructurePiece.h"
#include "ServerLevelListener.h"
#include "../../World/Math\WeighedTreasure.h"
#include "../Textures/TexturePackRepository.h"
#include "../Textures/DLCTexturePack.h"
#include "../../World/Entities\ProgressListener.h"
...
ServerLevel::ServerLevel(MinecraftServer *server, shared_ptr<LevelStorage>levelStorage, const wstring& levelName, int dimension, LevelSettings *levelSettings) : Level(levelStorage, levelName, levelSettings, Dimension::getNew(dimension), false)
{
	...
	// 4J - optimisation - keep direct reference of chunk source here
	chunkSourceDirect = chunkSource;
...
void ServerLevel::save(bool force, ProgressListener *progressListener, bool bAutosave)
{
...
#endif
	{
		...
		if (chunkMap->players.size() > 0)
		{
			...
			for (auto it = loadedChunkList->begin(); it != loadedChunkList->end(); ++it)
			{
				LevelChunk *lc = *it;
				if (!chunkMap->chunkInBufferRange(lc->x, lc->z))
				{
