...
public:
	...
	void				ClearGameUsers();
	void				CheckMultiplayerPrivileges(int iPad, bool bShowUI, void (*Func)(LPVOID, bool, int), LPVOID pParam);
	void				SetDeferredSignoutEnabled(bool bVal);
	void*				GetUser(int iPad, bool bIncludePending = false);
