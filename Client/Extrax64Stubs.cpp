...
// XMemCpy/XMemSet/XPhysicalAlloc now inline in extraX64.h
...
int IQNetPlayer::GetUserIndex() { return (int)(this - &IQNet::m_player[0]); }
...
/////////////////////////////////////////////// Input library new stubs
// Removed: now implemented in Platform/SDLInput.cpp
...
void				C_4JProfile::ShowAddFriend(int iPad, PlayerUID targetUid) {}
void				C_4JProfile::RemoveGamepadFromGame(int iPad) {}
void				C_4JProfile::ClearGameUsers() {}
void				C_4JProfile::CheckMultiplayerPrivileges(int iPad, bool bShowUI, void (*Func)(LPVOID, bool, int), LPVOID pParam) { if(Func) Func(pParam, true, iPad); }
void				C_4JProfile::SetDeferredSignoutEnabled(bool bVal) {}
void*				C_4JProfile::GetUser(int iPad, bool bIncludePending) { return nullptr; }
...
// CStorageManager stubs removed — now provided by Platform/StorageManager.cpp
...
char* getUsrDirPath() { static char path[] = "."; return path; }

/////////////////////////////////////////////////////// Telemetry manager global
...
/////////////////////////////////////////////////////// CopySaveDialogReturned stub
#include "Common\UI\UI.h"
#include "Common\UI\UIScene_LoadOrJoinMenu.h"
int UIScene_LoadOrJoinMenu::CopySaveDialogReturned(void *pParam, int iPad, CStorageManager::EMessageResult result) { return 0; }
