...
void CConsoleMinecraftApp::TMSPP_RetrieveFileList(int iPad,CStorageManager::eGlobalStorage eStorageFacility,eTMSAction NextAction)
{
	// stub - no TMS++ on Windows64
}
