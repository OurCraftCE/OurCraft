...
// 		}
    ...
    if (minecraft->options->renderDebug)
	{
		...
		//font->drawShadow(minecraft->gatherStats5(), iSafezoneXHalf+2, 32 + 10, 0xffffff);
       {
		...
		drawString(font, L"res: " + _toString<int>(minecraft->width_phys) + L"x" + _toString<int>(minecraft->height_phys) + L" aspect: " + _toString<float>(minecraft->getAspectRatio()), iSafezoneXHalf+2, iYPos + 8 * 4, 0xe0e0e0);
		iYPos += 8*5;
