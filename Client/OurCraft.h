...
public:
	...
	// Auto-start world system
	bool m_autoStarting;
	void autoStartWorld();

	// Auto-save system
	static const int AUTOSAVE_INTERVAL_TICKS = 20 * 60 * 5; // 5 minutes at 20 TPS
	int m_autoSaveTickCounter;
	bool m_autoSaveInProgress;
	void performAutoSave();
	void performSaveOnExit();
