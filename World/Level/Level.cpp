#include "stdafx.h"
#include "../IO/System.h"
#include "../Math/BasicTypeContainers.h"
#include "../IO/File.h"
...
int Level::getBrightness(LightLayer::variety layer, int x, int y, int z)
{
	...
	LevelChunk *c = chunkSourceDirect ? chunkSourceDirect->getChunk(xc, zc) : nullptr;
