...
#include "../../Client/MinecraftServer.h"
#include "../../Client/Game/ServerLevel.h"
#include "..\World\net.minecraft.world.level.h"
#include "../Level/LevelData.h"
#include "../../Client/Common/GameRules/LevelGenerationOptions.h"
...
void ConsoleSaveFileSplit::tick()
{
	...
	if( StorageManager.GetSaveState() != CStorageManager::ESaveGame_Idle )
	{
		return;
	}
