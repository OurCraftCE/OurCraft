#include "stdafx.h"
#include "Material.h"
#include "../Tiles/Materials/DecorationMaterial.h"
#include "../Tiles/Materials/GasMaterial.h"
#include "../Tiles/Materials/LiquidMaterial.h"
#include "../Tiles/Materials/PortalMaterial.h"
#include "../Tiles/Materials/WebMaterial.h"// 4J added, Java version just does a local alteration when instantiating the Material for webs to get the same thing
