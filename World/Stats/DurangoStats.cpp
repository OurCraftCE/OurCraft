...
#include "../Items/ItemStat.h"

#include "Achievement.h"
#include "Achievements.h"

#include "../Entities/DamageSource.h"
...
#include "../../Client/OurCraft.h"
#include "../Level/LevelData.h"
#include "../Level/LevelSettings.h"

#include "../../Client/Game/LocalPlayer.h"
#include "../../Client/Game/MultiPlayerLocalPlayer.h"

#include "../Network/EntityIO.h"

#ifdef _DURANGO
#include "..\Client\Durango\ServiceConfig\Events-XBLA.8-149E11AEEvents.h"
#else
// Stub out Xbox event tracing macros for non-Durango builds
#define EventWriteLeaderboardTotals(...) ERROR_SUCCESS
#define EventWriteBlockPlaced(...) ERROR_SUCCESS
#define EventWriteBlockBroken(...) ERROR_SUCCESS
#define EventWriteMcItemAcquired(...) ERROR_SUCCESS
#define EventWriteMobKilled(...) ERROR_SUCCESS
#define EventWriteMobInteract(...) ERROR_SUCCESS
#define EventWriteIncTimePlayed(...) ERROR_SUCCESS
#define EventWriteIncDistanceTravelled(...) ERROR_SUCCESS
#define EventWritePlayerSessionStart(...) ERROR_SUCCESS
#define EventWritePlayerSessionPause(...) ERROR_SUCCESS
#define EventWritePlayerSessionResume(...) ERROR_SUCCESS
#define EventWritePlayerSessionEnd(...) ERROR_SUCCESS
#define EventWriteItemUsed(...) ERROR_SUCCESS
#define EventWriteChangedDimension(...) ERROR_SUCCESS
#define EventWriteEnteredBiome(...) ERROR_SUCCESS
#define EventWriteAchievementUnlocked(...) ERROR_SUCCESS
#define EventWriteRichPresenceState(...) ERROR_SUCCESS
#define EventWriteMcItemUsed(...) ERROR_SUCCESS
#define EventWriteAchievementGet(...) ERROR_SUCCESS
#define EventWritePlayedMusicDisc(...) ERROR_SUCCESS
#define EventWriteChestfulOfCobblestone(...) ERROR_SUCCESS
#define EventWriteOverkill(...) ERROR_SUCCESS
#define EventWriteOnARail(...) ERROR_SUCCESS
#define EventWriteEnteredNewBiome(...) ERROR_SUCCESS
#endif
...
#else
void DurangoStats::setMultiplayerCorrelationId(LPCWSTR mcpId)
{
	((DurangoStats*)GenericStats::getInstance())->multiplayerCorrelationId = mcpId ? mcpId : L"";
}

LPCWSTR DurangoStats::getMultiplayerCorrelationId()
{
	return ((DurangoStats*)GenericStats::getInstance())->multiplayerCorrelationId.c_str();
}
#endif
...
void DurangoStats::playerSessionStart(PlayerUID uid, shared_ptr<Player> plr)
{
	...
	{
		//wprintf(std::to_wstring(uid).c_str());
